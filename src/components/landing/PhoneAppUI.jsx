...
const OverviewTab = () => (
  <div className="space-y-4 pb-4">
    ...
    {/* Deal Cards — real stock images, reduced border-radius */}
    <div className="space-y-2 px-3">
      {[
        ...
        },
        {
          ...
          status: 'Prüfung',
          color: '#f59e0b',
          image: 'https://images.unsplash.com/photo-1558171813-4c088753af8f?w=80&h=80&fit=crop&crop=center',
        },
        {
          ...
          status: 'Neu',
          color: '#ec4899',
          image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=80&h=80&fit=crop&crop=center',
        },
      ].map((deal, idx) => (
        <motion.div
          key={idx}
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 flex-1 min-w-0">
              <img
                ...
                style={{ border: `1.5px solid ${deal.color}25` }}
              />
