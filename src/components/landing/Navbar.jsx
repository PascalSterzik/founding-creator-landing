        ...
        <motion.nav
          ...
          style={{
            ...
            backgroundColor: isScrolled
              ? 'rgba(253, 250, 249, 0.95)'
              : 'rgba(253, 250, 249, 0.8)',
            borderBottom: isScrolled
              ? '1px solid rgba(75, 50, 45, 0.08)'
              : '1px solid rgba(75, 50, 45, 0.04)',
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="flex items-center justify-between h-16 sm:h-18">
              ...
              <motion.button
                ...
                className="relative px-6 py-2.5 rounded-full text-white font-semibold text-sm overflow-hidden cursor-pointer flex-shrink-0"
                style={{
